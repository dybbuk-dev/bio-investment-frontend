import { Card, Typography, CardContent, CardHeader, Stack, Table, TableBody, TableCell, TableContainer, TablePagination, TableRow, useTheme, TableHead, Checkbox, TableSortLabel, Box, Button } from "@mui/material";
...
export default function MyInvestmentHistory() {
    ...
    return (
        <Stack padding = {2}>
            <Stack direction = "row" gap = {1} mb = {2}>
                <Button variant = {'outlined'}>Invested Assert</Button>
